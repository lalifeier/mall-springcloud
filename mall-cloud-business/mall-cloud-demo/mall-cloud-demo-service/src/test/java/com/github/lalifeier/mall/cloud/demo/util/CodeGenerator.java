package com.github.lalifeier.mall.cloud.demo.util;
...
public class CodeGenerator {
  ...
  private static String dbUrl =
      "jdbc:mysql://localhost:3306/mall?useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai&useSSL=false";
  ...
  public static Consumer<PackageConfig.Builder> packageConfigConsumer() {
    return builder -> {
      builder.parent("com.github.lalifeier.mall.demo") // 设置父包名
          ...
          .serviceImpl("service.impl").mapper("mapper") // 生成mapper层
          .pathInfo(
              Collections.singletonMap(OutputFile.xml, projectPath + "/src/test/resources/mapper")); // 设置mapperXml生成路径
    };
  }

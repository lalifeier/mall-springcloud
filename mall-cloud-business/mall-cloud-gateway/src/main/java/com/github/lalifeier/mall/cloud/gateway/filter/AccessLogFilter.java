...
import com.github.lalifeier.mall.cloud.gateway.utils.IpUtil;
...
public class AccessLogFilter implements GlobalFilter, Ordered {
     ...
     * @return
     */
    private Mono<Void> writeBasicLog(
            ServerWebExchange exchange, GatewayFilterChain chain, GatewayLog accessLog) {
     ...
     */
    @SuppressWarnings("unchecked")
    private Mono writeBodyLog(
            ServerWebExchange exchange, GatewayFilterChain chain, GatewayLog gatewayLog) {
                        ...
                        Mono.defer(
                                () -> {
                                    ...
                                    ServerHttpRequest decoratedRequest =
                                            requestDecorate(exchange, headers, outputMessage);
    ...
    private ServerHttpResponseDecorator recordResponseLog(
            ServerWebExchange exchange, GatewayLog gatewayLog) {
        ...
        return new ServerHttpResponseDecorator(response) {
            ...
            public Mono<Void> writeWith(Publisher<? extends DataBuffer> body) {
                if (body instanceof Flux) {
                    ...
                    // 计算执行时间
                    long executeTime =
                            (responseTime.getTime() - gatewayLog.getRequestTime().getTime());

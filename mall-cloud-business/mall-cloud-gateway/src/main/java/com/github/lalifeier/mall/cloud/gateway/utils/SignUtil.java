...
public class SignUtil {
    ...
    public static String generateSign(
            String timestamp, String nonce, String requestPayload, ServerHttpRequest request) {
        ...
        String qs =
                String.format(
                        "%s&timestamp=%s&nonce=%s&key=%s", paramString, timestamp, nonce, KEY);
                                ...
                                name -> {
                                    try {
                                        return String.format(
                                                ...
                                                name,
                                                URLEncoder.encode(
                                                        params.get(name).toString(), "UTF-8"));

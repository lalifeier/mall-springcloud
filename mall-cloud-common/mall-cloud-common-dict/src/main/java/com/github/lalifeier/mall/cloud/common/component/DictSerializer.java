...
public class DictSerializer extends StdSerializer<Object> implements ContextualSerializer {
    ...
    private final Map<String, Map<String, String>> dictMapCache =
            new ConcurrentHashMap<>(); // 缓存字典映射表
    ...
    public JsonSerializer<?> createContextual(SerializerProvider prov, BeanProperty property) {
        ...
        if (dict == null) {
            throw new IllegalArgumentException(
                    "Missing Dict annotation for property " + property.getName());
        }
    ...
    public void serialize(Object value, JsonGenerator gen, SerializerProvider provider)
        ...
        try {
            ...
            Map<String, String> dictMap =
                    dictMapCache.computeIfAbsent(
                            dictType, key -> loadDictMap(dictType)); // 从缓存中获取字典映射表

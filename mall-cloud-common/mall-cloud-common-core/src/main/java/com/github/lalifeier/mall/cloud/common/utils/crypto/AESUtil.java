...
public class AESUtil {
   ...
   */
  public static String encrypt(String data, SecretKey secretKey, CipherAlgorithm cipherAlgorithm, byte[] iv) throws Exception {
   ...
   */
  public static String decrypt(String encryptedData, SecretKey secretKey, CipherAlgorithm cipherAlgorithm, byte[] iv) throws Exception {

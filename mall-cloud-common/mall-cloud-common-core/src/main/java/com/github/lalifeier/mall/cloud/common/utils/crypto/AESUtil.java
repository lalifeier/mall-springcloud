...
public class AESUtil {
    public enum CipherAlgorithm {
        ...
        AES_GCM_PKCS5Padding("AES/GCM/PKCS5Padding", 12);
    ...
    public static final CipherAlgorithm DEFAULT_CIPHER_ALGORITHM = CipherAlgorithm.AES_ECB_PKCS5Padding;
     ...
     */
    public static String encrypt(String data, SecretKey secretKey, CipherAlgorithm cipherAlgorithm, byte[] iv)
            throws Exception {
     ...
     */
    public static String decrypt(String encryptedData, SecretKey secretKey, CipherAlgorithm cipherAlgorithm, byte[] iv)
            throws Exception {
    ...
    public static String decrypt(String encryptedData, String key, CipherAlgorithm cipherAlgorithm, String iv)
            throws Exception {
        SecretKey secretKey = generateSecretKey(key);

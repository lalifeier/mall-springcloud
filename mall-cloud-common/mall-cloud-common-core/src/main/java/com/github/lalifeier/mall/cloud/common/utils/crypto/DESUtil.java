...
public class DESUtil {
     ...
     */
    public static String encrypt(String data, SecretKey key, CipherAlgorithm cipherAlgorithm, byte[] iv)
            throws Exception {
     ...
     */
    public static String decrypt(String encryptedData, SecretKey key, CipherAlgorithm cipherAlgorithm, byte[] iv)
            throws Exception {
        Cipher cipher = Cipher.getInstance(cipherAlgorithm.getAlgorithm());
        if (cipherAlgorithm.getAlgorithm().contains("CBC")) {
            IvParameterSpec ivParameterSpec = new IvParameterSpec(iv);

...
public class DESUtil {
  public enum CipherAlgorithm {
    DES_ECB_PKCS5Padding("DES/ECB/PKCS5Padding"), DES_CBC_PKCS5Padding(
        "DES/CBC/PKCS5Padding"), DESede_ECB_PKCS5Padding(
            "DESede/ECB/PKCS5Padding"), DESede_CBC_PKCS5Padding("DESede/CBC/PKCS5Padding");
   ...
   */
  public static String encrypt(String data, SecretKey key, CipherAlgorithm cipherAlgorithm,
   ...
   */
  public static String decrypt(String encryptedData, SecretKey key, CipherAlgorithm cipherAlgorithm,
      byte[] iv) throws Exception {
    Cipher cipher = Cipher.getInstance(cipherAlgorithm.getAlgorithm());
    if (cipherAlgorithm.getAlgorithm().contains("CBC")) {
      IvParameterSpec ivParameterSpec = new IvParameterSpec(iv);

...
public class EnumUtil {
  ...
  public static String getEnumFieldName(Class<?> enumClass) {
    if (BaseEnum.class.isAssignableFrom(enumClass)) {
      ...
      return getEnumAnnotationField(enumClass).map(Field::getName)
          .orElseThrow(() -> new IllegalArgumentException(String
              .format("Could not find appropriate property in Class: %s.", enumClass.getName())));
    }
  }
  ...
  public static Optional<Field> getAnnotationField(Class<?> enumClass) {
    return getFieldWithAnnotations(enumClass, new Class[] {JsonValue.class, EnumValue.class});
  }
   ...
   * @return 带有指定注解的字段的Optional，如果没有找到匹配的字段，则为空
   */
  public static Optional<Field> getFieldWithAnnotations(Class<?> enumClass,
  ...
  public static Class<?> getEnum1(Class<?> enumClass, String value) {

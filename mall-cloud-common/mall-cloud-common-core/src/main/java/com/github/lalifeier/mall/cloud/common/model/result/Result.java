...
public class Result<T> {
  ...
  public static Result<Object> success() {
    return new Result<>(ErrorCodeEnum.SUCCESS.getCode(), ErrorCodeEnum.SUCCESS.getStatus(), null,
        null, null);
  }
  ...
  public static Result<Object> failure(ErrorCode errorCode) {
    return new Result<>(errorCode.getCode(), errorCode.getStatus(), errorCode.getDescription(),

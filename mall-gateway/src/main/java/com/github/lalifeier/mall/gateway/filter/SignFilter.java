...
import com.github.lalifeier.mall.gateway.constant.Common;
import com.github.lalifeier.mall.gateway.properties.SignProperties;
import com.github.lalifeier.mall.gateway.utils.FilterRequestResponseUtil;
import com.github.lalifeier.mall.gateway.utils.SignUtil;
...
public class SignFilter implements GlobalFilter, Ordered {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        //
        //// 对请求头参数进行签名
        //if (StringUtils.isBlank(signature) || !StringUtils.equals(signature, SignUtil.generateSign(timestamp, nonce, requestPayload, request))) {

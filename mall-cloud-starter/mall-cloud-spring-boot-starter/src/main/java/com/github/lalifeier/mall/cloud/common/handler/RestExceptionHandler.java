...
public class RestExceptionHandler {
  ...
  public Result<?> processException(HttpServletRequest request, HttpServletResponse response,
      Exception exception) {
  ...
  public Result<?> handleValidatedException(HttpServletRequest request,
  ...
  public Result<?> handleValidatedException(HttpServletRequest request, BindException exception) {
    log.error("BadRequestException, request: {}", parseParam(request), exception);
    String message = exception.getAllErrors().stream().map(ObjectError::getDefaultMessage)

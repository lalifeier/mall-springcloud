...
public class RepeatSubmitAspect {
  ...
  private String generateParamKey(HttpServletRequest request) throws IOException {
    ...
    return generateIdentifier(request.getRequestURI(), request.getParameterMap(), request.getReader().lines().collect(Collectors.joining(System.lineSeparator())), ipAddress);
  }

  private static String generateIdentifier(String url, Map<String, String[]> params, String body, String ipAddress) {
    try {

...
public class HttpUtil {
  ...
  public static <T> T post(String url, MultiValueMap<String, String> data, Class<T> responseType) {
    return invoke(url, HttpMethod.POST, data, MediaType.APPLICATION_FORM_URLENCODED, null,
        responseType);
  }
  ...
  public static <T, E> T invoke(String url, HttpMethod method, E data, MediaType contentType,

...
public class LogRecordOperationSource {
  ...
  private LogRecord parse(AnnotatedElement ae, OperationLog annotation) {
    LogRecord logRecord = new LogRecord().setBizNo(annotation.bizNo()).setType(annotation.type())
        .setSubType(annotation.subType()).setSuccess(annotation.success())
        .setFail(annotation.fail()).setExtra(annotation.extra())
        .setOperatorId(annotation.operatorId()).setOperatorName(annotation.operatorName())

...
public class OperationLogAspect {
  ...
  public Object around(ProceedingJoinPoint pjp) throws Throwable {
    ...
    try {
      operations = logRecordOperationSource.computeLogRecordOperations(methodInfo.getMethod(), methodInfo.getClass());
  ...
  private void recordExecute(ExecuteResult executeResult, Map<String, String> functionNameAndReturnMap,

...
public class OperationLogAspect {
    ...
    public Object around(ProceedingJoinPoint pjp) throws Throwable {
        ...
        try {
            operations =
                    logRecordOperationSource.computeLogRecordOperations(methodInfo.getMethod(), methodInfo.getClass());
    ...
    private void recordExecute(
        ...
        for (LogRecord operation : operations) {
            try {
                if (StringUtils.isEmpty(operation.getSuccess()) && StringUtils.isEmpty(operation.getFail())) {
                    continue;
                }
            } catch (Exception e) {

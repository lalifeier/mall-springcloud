package com.github.lalifeier.mall.cloud.logging.aspect;

import com.github.lalifeier.mall.cloud.logging.annotation.SysLog;
...
public class SysLogAspect {
    ...
    @Pointcut("@annotation(com.github.lalifeier.mall.cloud.logging.annotation.SysLog)")

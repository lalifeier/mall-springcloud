package com.github.lalifeier.mall.cloud.gateway.infrastructure.utils;
...
public class SignUtil {
    ...
    public static String generateSign(String timestamp, String nonce, String requestPayload, ServerHttpRequest request) {
